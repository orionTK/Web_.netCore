    ...
    public partial class NorthwindContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                optionsBuilder.UseSqlServer("Data Source=.\\SQLEXPRESSOR;Initial Catalog=Northwind;Persist Security Info=True;User ID=sa;Password=thanhkieuvt24;Pooling=False;MultipleActiveResultSets=False;Encrypt=False;TrustServerCertificate=True;");
            }
        }
